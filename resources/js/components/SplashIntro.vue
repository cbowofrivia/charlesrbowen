...
<template>
    <div
        ...
        :class="done ? 'pointer-events-none -translate-y-4 opacity-0' : 'opacity-100'"
    >
        <!-- Avatar -->
        <Avatar
            class="mb-5 size-14"
            :style="{
                animation: started
                    ? 'fade-in 0.4s ease-out 0.1s both'
                    : 'none',
                opacity: 0,
            }"
        >
        ...
        <div class="mb-3">
            <span
                class="inline-block overflow-hidden whitespace-nowrap border-r-[3px] text-2xl font-bold text-od-bright"
                :style="{
                    animation: started
        ...
        <p
            ...
            :style="{
                animation: started
                    ? 'flicker-in 0.4s ease-out 1.4s both'
                    : 'none',
                opacity: 0,
            }"
        >
        ...
        <p
            ...
            :style="{
                animation: started
                    ? 'fade-in 0.8s ease-out 2.5s both'
                    : 'none',
                opacity: 0,
            }"
        >
        ...
        <div
            ...
            :style="{
                animation: started
                    ? 'fade-slide-up 0.6s ease-out 3.2s both'
                    : 'none',
                opacity: 0,
            }"
        >
        ...
        <p
            ...
            :style="{
                animation: started
                    ? 'fade-in 0.5s ease-out 3.6s both'
                    : 'none',
                opacity: 0,
            }"
        >
